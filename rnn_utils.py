...
def get_network(frames, input_size, num_classes):
    ...
    net = tflearn.lstm(net, 256, weights_init="xavier", dropout=0.2, return_seq=True)
    net = tflearn.lstm(net, 256, weights_init="xavier", dropout=0.2)
    net = tflearn.fully_connected(net, num_classes, activation='softmax')
    net = tflearn.regression(net, optimizer='adam', learning_rate=0.001, loss='categorical_crossentropy', name="output1")
    return net